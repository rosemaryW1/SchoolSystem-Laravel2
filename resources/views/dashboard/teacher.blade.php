<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-orange-200 text-center border border-orange-300 px-8 py-6 rounded">
            <h3 class="text-orange-700 uppercase font-bold">
        ...
        <div class="w-full bg-orange-200 text-center border border-orange-300 px-8 py-6 mx-0 sm:mx-6 my-4 sm:my-0 rounded">
            <h3 class="text-orange-700 uppercase font-bold">
...
<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full sm:w-1/2 mr-2 mb-6">
            <h3 class="text-orange-700 uppercase font-bold mb-2">Class List</h3>
            <div class="flex flex-wrap items-center">
                @foreach ($teacher->classes as $class)
                    <div class="w-full sm:w-1/2 text-center border border-orange-400 rounded">
                        <div class="text-orange-800 uppercase font-semibold px-4 py-4 mb-2">{{ $class->class_name }}</div>
                        <a href="{{ route('teacher.attendance.create',$class->id) }}" class="bg-green-600 inline-block mb-4 text-xs text-white uppercase font-semibold px-4 py-2 border border-orange-200 rounded">Manage Attendence</a>
                    </div>
                @endforeach
            </div>
        </div>
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            <h3 class="text-orange-700 uppercase font-bold mb-2">Subject List</h3>
            <div class="flex items-center bg-orange-600 rounded-tl rounded-tr">
            ...
            @foreach ($teacher->subjects as $subject)
                <div class="flex items-center justify-between border border-orange-200">
