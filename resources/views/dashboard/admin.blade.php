<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-black-200 text-center border border-orange-300 px-8 py-6 rounded">
        ...
        <div class="w-full bg-black-200 text-center border border-orange-300 px-8 py-6 mx-0 sm:mx-6 my-4 sm:my-0 rounded">
            <h3 class="text-black-700 uppercase font-bold">
