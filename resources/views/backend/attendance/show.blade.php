    ...
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div><!-- Log on to codeastro.com for more projects -->
                <h2 class="text-black-700 uppercase font-bold">Attendance</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            <div class="flex items-center justify-between px-6 py-6 pb-0">
                <div class="border-l-4 border-black-600 pl-2">
                    <h2 class="text-black-700 uppercase font-bold">{{ $attendances[0]->student->user->name ?? '' }}</h2>
                </div>
            </div>

            <div class="w-full px-6 py-6">
                <div class="flex items-center justify-between bg-orange-600 rounded-tl rounded-tr">
