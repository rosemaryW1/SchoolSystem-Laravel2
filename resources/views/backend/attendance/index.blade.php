...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-black-700 uppercase font-bold">Attendance Report</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('home') }}" class="bg-black-700 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="w-full mt-8 bg-white rounded">
            <form action="{{ route('attendance.index') }}" method="GET" class="md:flex md:items-center md:justify-between px-6 py-6 pb-0">
                <div class="md:flex md:items-center mb-6 text-gray-700 uppercase font-bold">
                    ...
                    <div class="flex flex-row items-center bg-gray-200 px-4 py-3 rounded">
                        <label class="block text-orange-600 font-bold">
                ...
                <div class="md:flex md:items-center mb-6 text-gray-700 uppercase font-bold">
                    ...
                    <div class="block text-orange-600 font-bold">
                        <div class="relative">
                ...
                <div class="md:flex md:items-center mb-6 text-orange-700 uppercase font-bold">
                    <button class="shadow bg-orange-500 hover:bg-white-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">Generate</button>
                </div>
            </form>
            <!-- Log on to codeastro.com for more projects -->
            <div class="w-full px-6 py-6">
                @foreach ($attendances as $classid => $datevalues)
                    ...
                    <div class="flex flex-col bg-black-200 mb-6">
                        @foreach ($datevalues as $key => $attendancevals)
                            <div class="text-left text-black-800 py-2 px-4 font-semibold">
                                <b><span >{{ $key }}</span></b>
                                <div class="flex flex-col justify-between bg-black-100">
                                    @foreach ($attendancevals as $vals => $attendance)
                                        <div class="flex flex-row justify-between w-64">
                                            <div class="text-sm text-left text-black-600 py-2 px-4 font-semibold">{{ $attendance->student->user->name }}</div>
                                            <div class="text-sm text-left text-black-600 py-2 px-4 font-semibold">
