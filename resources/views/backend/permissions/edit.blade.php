...
@section('content')
    <div class="permissions">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-orange-700 uppercase font-bold">Edit Permission</h2>
            </div>
        ...
        <div class="mt-8 bg-white rounded">
            <form action="{{ route('permission.update',$permission->id) }}" method="POST" class="w-full max-w-lg px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="name" class="bg-orange-200 appearance-none border-2 border-orange-200 rounded w-full py-2 px-4 text-orange-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500" id="inline-full-name" type="text" value="{{ $permission->name }}">
                        @error('name')
