...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-orange-700 uppercase font-bold">Add New Student</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('student.store') }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="roll_number" class="bg-orange-200 appearance-none border-2 border-orange-200 rounded w-full py-2 px-4 text-orange-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500" type="number" value="{{ old('roll_number') }}">
                        @error('roll_number')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="dateofbirth" id="datepicker-sc" autocomplete="off" class="bg-orange-200 appearance-none border-2 border-orange-200 rounded w-full py-2 px-4 text-orange-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500" type="text" value="{{ old('dateofbirth') }}">
                        @error('dateofbirth')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3 block text-orange-600 font-bold">
                        <div class="relative">
                            <select name="class_id" class="block appearance-none w-full bg-orange-200 border border-orange-200 text-orange-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-orange-500" id="grid-state">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3 block text-orange-600 font-bold">
                        <div class="relative">
                            <select name="parent_id" class="block appearance-none w-full bg-orange-200 border border-orange-200 text-orange-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-orange-500" id="grid-state">
